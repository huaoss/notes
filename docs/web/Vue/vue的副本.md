...
### Vue2.0的八种常用传值方式、父传子、子传父、非父子组件传值
...
1. Vue的watch属性可以用来监听data属性中数据的变化
...
2. computed属性的作用与watch类似，也可以监听属性的变化
